...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_type", default='cam', type=str)
    ...
    infer_dataset = tool.data.VOC12ImageDataset(args.infer_list, voc12_root=args.voc12_root,
